export const OneDayTicketCard = () => {
  return (
    <div className="rounded-3xl bg-white/2.5 p-8 ring-1 ring-white/10 sm:mx-8 sm:p-10 lg:mx-0 h-full">
      ...
      <a
        ...
        className="mt-8 block rounded-md bg-white/10 px-3.5 py-2.5 text-center text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-sky-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/75 sm:mt-10"
      >
        Comprar Ya
      </a>
    </div>
